...
const BookModalUpdate = (props) => {
    const {setDataUpdateBook, dataUpdateBook, setModalOpenUpdateBook, modalOpenUpdateBook} = props;
    ...
    return (
        <>
            <Modal
                title="Cập nhật thông tin book"
                open={modalOpenUpdateBook}
                onOk={() => { form.submit() }}
                onCancel={() => {
                    form.resetFields();
                    setInitForm(null)
